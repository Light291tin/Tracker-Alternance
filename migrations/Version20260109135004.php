 ...
 */
final class Version20260109135004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, company VARCHAR(255) NOT NULL, platform VARCHAR(255) NOT NULL, applied_at DATE NOT NULL, status VARCHAR(50) NOT NULL, interview_date DATETIME DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_A45BDDC1A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
